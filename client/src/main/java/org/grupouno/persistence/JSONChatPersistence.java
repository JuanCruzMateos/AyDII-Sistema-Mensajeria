...
public class JSONChatPersistence extends AbstractChatPersistence {

    public JSONChatPersistence(String fileName) throws IOException {
        super(fileName + "_Chat.json");
    }
    ...
    public void saveChat() {
        ...
        try {
            ...
            writer.write("}");
            writer.close();
            logger.info("JSON Chat Finalizado");
        } catch (IOException e) {
